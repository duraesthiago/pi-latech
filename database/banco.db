...
CREATE TABLE `purchases` (
  ...
  KEY `fk_Pedidos_Clientes1_idx` (`Users_idUsers`),
  CONSTRAINT `fk_Pedidos_Clientes1` FOREIGN KEY (`Users_idUsers`) REFERENCES `users` (`idUsers`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-11-29 12:47:38
