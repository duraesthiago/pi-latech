...
CREATE TABLE `addresses` (
  ...
  KEY `fk_addresses_users1_idx` (`users_idClientes`),
  CONSTRAINT `fk_addresses_users1` FOREIGN KEY (`users_idClientes`) REFERENCES `users` (`idClientes`)
...
INSERT INTO `users` VALUES (1,'Ana','Santos Silva','ana@email.com','7198888888','123456',NULL),(2,'Lucas','Lima Paz','lucas@email.com','71991919191','654321',NULL);
...
-- Dump completed on 2022-12-18 15:11:07
